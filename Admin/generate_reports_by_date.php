<?php
	...
	{  
		...
		$sql_query="SELECT * FROM request ORDER BY date_from, date_to ASC";  
	...
	{  
		...
		$obj_pdf->SetTitle("Summary of Requests Order By Date");  
...
<body>
	...
	<div class="main-body">
		...
		<div>
			...
			<tr><td><button class="back_to_menu" onclick="location='manage_reports.php'"/>◄ Back to Manage Reports</button></td></tr><br>
			<form method="POST">
